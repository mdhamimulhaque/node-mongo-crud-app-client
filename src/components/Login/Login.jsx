        ...
        <div className="flex flex-wrap w-full">
            <div className="flex flex-col w-full md:w-1/2">
                <div className="flex justify-center pt-12 md:justify-start md:pl-12 md:-mb-24">
                    <span className="p-4 text-xl font-bold text-white bg-gray-900">
                        Log In
                    </span>
                </div>
                <div className="flex flex-col justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
                    ...
                    <form className="flex flex-col pt-3 md:pt-8">
                        ...
                        <button type="submit" className="w-full px-4 py-2 text-base font-semibold text-center text-white transition duration-200 ease-in bg-gray-900 shadow-md hover:bg-gray-900 hover:bg-white focus:outline-none focus:ring-2">
                    ...
                    <div className="pt-12 pb-12 text-center">
                        <p>
                            ...
                            <Link to="/registration" className="font-semibold underline text-blue-500 hover:text-blue-800">
                                Register here.
                            </Link>
                        </p>
                    </div>
            ...
            <div className="w-1/2 shadow-2xl">
                <img className="hidden object-cover w-full h-screen md:block"
                    src={`https://img.freepik.com/free-vector/tablet-login-concept-illustration_114360-7883.jpg?w=826&t=st=1667797562~exp=1667798162~hmac=9debe542b497995ddb43802593e9232de33e08bcb21595deb3501b557bf50964`} />
            </div>
        </div>
